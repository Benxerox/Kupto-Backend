// server.js (or index.js) — FULL UPDATED (keeps ALL your logic, fixes CORS + ordering)
...
/* ======================================================
   ...
   - Allows localhost:3000 dev + your prod domains
   - Allows common headers automatically
...
const corsOptions = {
  origin: function (origin, callback) {
    // allow mobile/native or server-to-server calls that have no Origin header
  ...
  // ✅ include common headers used by browsers/libs (or you can remove this line entirely)
  allowedHeaders: ["Content-Type", "Authorization", "X-Requested-With"],
  optionsSuccessStatus: 204,
};

// ✅ Apply CORS globally BEFORE everything
app.use(cors(corsOptions));

// ✅ Make sure preflight always responds
...
/* ======================================================
   ✅ MTN MOMO (your original logic kept)
====================================================== */
...
/* ======================================================
   ✅ AIRTEL (your original logic kept)
====================================================== */
...
/* ======================================================
   ✅ API ROUTES (your original routes kept)
====================================================== */
